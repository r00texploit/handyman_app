              ...
              child: AnimatedScrollView(
                ...
                children: [
                  ...
                  AppTextField(
                    ...
                    decoration: inputDecoration(context, hintText: language.accountNumber, counter: false),
                    ...
                    validator: (accNumberCont) {
                      if (accNumberCont == null || accNumberCont.isEmpty) {
                        return language.lblPleaseEnterAccountNumber;
                      }
                      if (!RegExp(r'^[0-9]+$').hasMatch(accNumberCont)) {
                        return language.lblAccountNumberMustContainOnlyDigits;
                      }
                      if (accNumberCont.length < 11 || accNumberCont.length > 16) {
                        return language.lblAccountNumberMustBetween11And16Digits;
                      }
                      return null;
                    },
                    maxLength: 16,
